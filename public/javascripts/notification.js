document.addEventListener("DOMContentLoaded", () => {
    const applicationServerKey = "BBI0WCCLl9BKOvNHBDapUkLwjXq3Qjz1SdKUvsg1ycEoCkne/NKj+SSM0sq3rJdYJwFl/hmVaLIyUFzlp+53vI8=";
    ...
    function push_updateSubscription() {
        ...
        .catch(e => {
            console.error('Error updating the subscription', e);
        });
    }
    ...
    function push_sendSubscriptionToServer(subscription, method) {
        ...
        return fetch(window.location+'src/models/notification/push_subscription.php', {
            method,
            body: JSON.stringify({
        ...
        }).then(() => subscription).then(console.log(subscription));
    ...
    sendPushButton.addEventListener('click', () =>
        ...
        .then(subscription => {
            ...
            const contentEncoding = (PushManager.supportedContentEncodings || ['aesgcm'])[0];
            fetch(window.location+'src/models/notification/send_push_notification.php', {
                method: 'POST',
                body: JSON.stringify({
                    endpoint: subscription.endpoint,
