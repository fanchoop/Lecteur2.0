...
<html lang="fr">
  <head>
    ...
    <link rel="stylesheet" href="../../public/stylesheets/player_mini.css">
      ...
      <div class="player">
        ...
        <div class="controls">
          ...
          <button class="next">Suivant</button><span class="volume">
            <button class="volume_button volume-moyen2" data-value="90">Volume</button><span class="volume_slider"><span class="volume_sliderTotale">
...
Voici le player :
  ...
  <div class="audioplayer-mini">
  </div>
<!--  <div class="modal">-->
<!--      <div class="share-pannel share-hidden">-->
<!--          <div class="share-header"><span class="close">×</span>-->
<!--              <p>Intégrer le player</p>-->
<!--          </div>-->
<!--          <div class="share-body">-->
<!--              <p>Code d'intégration :</p>-->
<!--              <input class="share-input-text" readonly="readonly" value="" type="text">-->
<!--          </div>-->
<!--          <button class="copy-button"></button>-->
<!--      </div>-->
<!--  </div>-->
    <script src="../../public/javascripts/polyfillClassList.js"></script>
    <script src="../../public/javascripts/script/soundmanager2-nodebug-jsmin.js"></script>
    ...
    <script src="../../public/javascripts/SuperPlayer.js"></script>
    <script src="../../public/javascripts/SuperPlayerDom.js"></script>
...
window.onload = function () {
    ...
    var sP = new SuperPlayer(document.querySelector('body div.audioplayer-mini'));
    ...
    var p2 = new Player(document.querySelector('#player3 .audioplayer'));
    p2.addMusicObject(music1);
